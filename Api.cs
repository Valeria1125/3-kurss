...
namespace couse_work_web
{
    public class Api
    {
        ...
        static string server = "https://localhost:44369/api/";
        ...
        public static async Task<V> PostAsync<T, V>(T value, string controller) where T : ModelsApi.ApiBaseType where V : class
        {
